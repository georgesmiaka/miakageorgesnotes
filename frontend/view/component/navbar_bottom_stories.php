...
<div class="bottom_navbar">
    <div>
        ...
        <a href="/frontend/view/page/stories/programming.php" class="last_menu simple_menu" style="float:right">
            <div class="menu_icon">
        ...
        <a href="/frontend/view/page/stories/science.php" style="float:right">
            <div class="menu_icon">
        ...
        <a href="/frontend/view/page/stories/photography.php"  style="float:right">
            <div class="menu_icon">
